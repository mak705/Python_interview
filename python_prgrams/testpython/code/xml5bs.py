...
#Actual data: http://python-data.dr-chuck.net/comments_287607.xml (Sum ends with 44)
...
# Retrieve all of the count tags
tags = soup('count')
for tag in tags:
        print 'TAG:',tag
    # Look at the parts of a tags to find number values

        x = re.findall('[0-9]+', html)

        #convert number values to integers
new_list = []
for item in x:
